                        ...
                        <div class="card bg-authentication rounded-0 mb-0">
                            <div class="row m-0">
                                            ...
                                            <div class="card-body pt-1">
                                                ...
                                                <form method="POST" action="{{ route('login') }}">
                                                    ...
                                                    <fieldset class="form-label-group form-group position-relative has-icon-left">
                                                        <input type="text" class="form-control  @error('user_name') is-invalid @enderror" value="{{ old('user_name') }}" name="user_name" id="user_name" placeholder="Username" required>
                                ...
                                @enderror
                                                    ...
                                                    <button type="submit" style="margin-bottom: 20px" class="btn btn-primary float-right btn-inline">Login</button>
                                                </form>
                                            </div>
                                        </div>
